...
class SourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('settings.source_query.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            if ($id == 0 || $id == '') {
                $ret = SourceQuery::create($data);
            }else{
                $ret=SourceQuery::where('id',$id)->update($data);
            }
            DB::commit();
            return $ret;
