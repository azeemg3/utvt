...
class SectorController extends Controller
{
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button type="button" class="btn btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
                      ...
                      <div class="dropdown-menu" role="menu" style="">
                        ...
                        <a class="dropdown-item text-danger del_rec" href="javascript:void(0)" data-id="'.$row->id.'" data-action="'.route('sector.store').'"><i class="fas fa-trash"></i> Delete</a>
                      </div>
    ...
    public function store(Request $request)
    {
        ...
        try {
            if ($id == 0 || $id == '') {
                $ret = Sector::create($data);
            }else{
                $ret=Sector::where('id',$id)->update($data);
            }
            DB::commit();
            return $ret;
