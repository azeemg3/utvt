...
@if(in_array(Request::segment(3),$settings)) menu-open @endif">
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item has-treeview @if(in_array(Request::segment(3),$settings)) menu-open @endif">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('user.index') }}" class="nav-link @if(Request::segment(3)=='user') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('role.index') }}" class="nav-link @if(Request::segment(3)=='role') active @endif">
                        <i class="far fa-circle nav-icon"></i>
