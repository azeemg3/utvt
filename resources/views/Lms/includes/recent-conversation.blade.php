            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" name="contact_via">
                ...
                <div class="col-md-2 reminder" style="display: none">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm date" placeholder="{{ date('m-d-Y') }}" name="reminder_date">
                    </div>
                </div>
                <!--col-->
                <div class="col-md-2 reminder" style="display: none">
                    <div class="form-group">
                       ...
                       <input type="time" class="from-control form-control-sm" name="reminder_time">
                      </div>
                </div>
                <!--col-->
