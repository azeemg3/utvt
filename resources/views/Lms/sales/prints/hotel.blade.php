...
<div class="col-md-12" style="position: relative;min-height: 100%;height: 100%;">
    ...
    <table width="100%" style="font-family: sans-serif; margin-top: 20px;font-size: 12px">
        ...
        <tr style="text-align: center;">
            <td colspan="2"><h4 style="margin-bottom: 0px;margin-top: 0px;font-size: 14px;padding: 7px 0px;font-weight: 600;">Hotel Invoice</h4></td>
        </tr>
    </table>
    <table style="width: 100%; font-family: sans-serif;text-align: center;border-collapse: collapse; margin-top: 0px;font-size: 12px;" cellpadding="2">
        ...
        @foreach($result as $item)
            ...
            <tr style="border: 1px solid #000;">
                ...
                <td style="border: 1px solid #000;text-align:center"><i class="fa fa-ticket" aria-hidden="true"></i> {{ $item->hotels->name }}</td>
                <td style="border: 1px solid #000; text-align:center;">{{ $item->confirmation }}</td>
                <td style="border: 1px solid #000;text-align:center">{{  $item->checkin }}</td>
                <td style="border: 1px solid #000;text-align:center">{{  $item->checkout }}</td>
                <td style="border: 1px solid #000;text-align:center">{{  $item->nights }}</td>
